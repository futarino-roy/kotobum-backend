...
class SendImageMessage extends Notification implements LineMessageInterface
{
    use Queueable;
    ...
    {
        return view('line.image_message', ['user' => $notifiable, 'image_url' => $this->image_url])->render();
    }
