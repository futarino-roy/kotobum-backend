...
<body style="background-color:{{$colors['backgroundColor'] ?? '#000000' }}; text-align:center; font-family:notosansjp,sans-serif;">
    ...
    <div id="textArea21" style="position:absolute; width:{{$textData[6]['width']??'50'}}%; height:{{$textData[6]['height']??'50'}}%; top:{{$textData[6]['top']??'50'}}%; left:{{$textData[6]['left']??'50'}}%; text-align:justify; writing-mode:vertical-rl; font-size:7.5pt; text-orientation:upright; letter-spacing:1pt;">{{$textData[6]['text'] ?? ''}}</div>
    ...
    <div id="textArea19" style="position:absolute; width:{{$textData[8]['width']??'50'}}%; height:{{$textData[8]['height']??'50'}}%; top:{{$textData[8]['top']??'50'}}%; left:{{$textData[8]['left']??'50'}}%; text-align:justify; writing-mode:vertical-rl; font-size:7.5pt; text-orientation:upright; letter-spacing:1pt;">{{$textData[8]['text'] ?? ''}}</div>
    ...
    <div id="textArea17" style="position:absolute; width:{{$textData[10]['width']??'50'}}%; height:{{$textData[10]['height']??'50'}}%; top:{{$textData[10]['top']??'50'}}%; left:{{$textData[10]['left']??'50'}}%; text-align:justify; writing-mode:vertical-rl; font-size:7.5pt; text-orientation:upright; letter-spacing:1pt;">{{$textData[10]['text'] ?? ''}}</div>
    ...
    <div id="frontimg16" style="position:absolute; width:{{$imageData[6]['width']??'50'}}pt; height:{{$imageData[6]['height']??'50'}}pt; top:{{$imageData[6]['top']??'50'}}pt; left:{{$imageData[6]['left']??'50'}}pt; background-image: url('{{$imageData[6]['image'] }}')"></div>
    ...
    <div id="textArea15" style="position:absolute; width:{{$textData[13]['width']??'50'}}%; height:{{$textData[13]['height']??'50'}}%; top:{{$textData[13]['top']??'50'}}%; left:{{$textData[13]['left']??'50'}}%; text-align:justify; writing-mode:vertical-rl; font-size:7.5pt; text-orientation:upright; letter-spacing:1pt;">{{$textData[13]['text'] ?? ''}}</div>
