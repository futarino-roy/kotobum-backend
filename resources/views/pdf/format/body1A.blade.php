...
<body style="background-color:{{$colors['backgroundColor'] ?? '#000000' }}; text-align:center; font-family:notosansjp,sans-serif;">
    ...
    <div id="frontimg24-3" style="position:absolute; width:65%; height:29.8%; top:55.56%; left:17.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[2]['image'] }}');"></div>
