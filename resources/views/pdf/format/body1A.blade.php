...
<body style="background-color:{{ $colors['backgroundColor'] ?? '#000000' }}; text-align:center;">
  ...
  <div id="frontimg13" style="position:absolute; width:{{ $imageData[8]['width'] ?? '50'}}pt; height:{{ $imageData[8]['height'] ?? '50'}}pt; top:{{ $imageData[8]['top'] ?? '50'}}pt;  left:{{ $imageData[8]['left'] ?? '50'}}pt;"><img src="{{ $imageData[8]['image'] }}" id="dropArea13" class="empty droparea" style="width:{{ $imageData[8]['width'] ?? '50'}}pt; height:{{ $imageData[8]['height'] ?? '50'}}pt;"></div>
