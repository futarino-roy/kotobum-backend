...
<body style="background-color:{{$colors['backgroundColor'] ?? '#000000' }}; ">
  ...
  <div id="frontimg1" class="img-radius" style="position:absolute; width:{{$imageData[0]['width']??'50'}}pt; height:{{$imageData[0]['height']??'50'}}pt; top:{{$imageData[0]['top']??'50'}}pt; left:{{$imageData[0]['left']??'50'}}pt;"><img src="{{ $imageData[0]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg2" class="img-radius" style="position:absolute; width:{{$imageData[1]['width']??'50'}}pt; height:{{$imageData[1]['height']??'50'}}pt; top:{{$imageData[1]['top']??'50'}}pt; left:{{$imageData[1]['left']??'50'}}pt;"><img src="{{ $imageData[1]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg4" class="img-radius" style="position:absolute; width:{{$imageData[2]['width']??'50'}}pt; height:{{$imageData[2]['height']??'50'}}pt; top:{{$imageData[2]['top']??'50'}}pt; left:{{$imageData[2]['left']??'50'}}pt;"><img src="{{ $imageData[2]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg6" class="img-radius" style="position:absolute; width:{{$imageData[3]['width']??'50'}}pt; height:{{$imageData[3]['height']??'50'}}pt; top:{{$imageData[3]['top']??'50'}}pt; left:{{$imageData[3]['left']??'50'}}pt;"><img src="{{ $imageData[3]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg8" class="img-radius" style="position:absolute; width:{{$imageData[4]['width']??'50'}}pt; height:{{$imageData[4]['height']??'50'}}pt; top:{{$imageData[4]['top']??'50'}}pt; left:{{$imageData[4]['left']??'50'}}pt;"><img src="{{ $imageData[4]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg10" class="img-radius" style="position:absolute; width:{{$imageData[5]['width']??'50'}}pt; height:{{$imageData[5]['height']??'50'}}pt; top:{{$imageData[5]['top']??'50'}}pt; left:{{$imageData[5]['left']??'50'}}pt;"><img src="{{ $imageData[5]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg12-1" class="img-radius" style="position:absolute; width:{{$imageData[6]['width']??'50'}}pt; height:{{$imageData[6]['height']??'50'}}pt; top:{{$imageData[6]['top']??'50'}}pt; left:{{$imageData[6]['left']??'50'}}pt;"><img src="{{ $imageData[6]['image'] }}" style="width:100%; height:100%;"></div>
  ...
  <div id="frontimg12-2" class="img-radius" style="position:absolute; width:{{$imageData[7]['width']??'50'}}pt; height:{{$imageData[7]['height']??'50'}}pt; top:{{$imageData[7]['top']??'50'}}pt; left:{{$imageData[7]['left']??'50'}}pt;"><img src="{{ $imageData[7]['image'] }}" style="width:100%; height:100%;"></div>
