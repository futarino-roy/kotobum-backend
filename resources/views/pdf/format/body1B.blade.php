...
<body style="background-color:{{$colors['backgroundColor'] ?? '#000000' }}; text-align:center; font-family:notosansjp,sans-serif;">
    ...
    <div id="frontimg2" class="img-radius" style="position:absolute; width:50%; height:28.21%; top:{{$imageData[1]['top']??'50'}}%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[1]['image'] }}')"></div>
    ...
    <div id="textArea3" style="position:absolute; width:{{$textData[4]['width']??'50'}}%; height:{{$textData[4]['height']??'50'}}%; top:{{$textData[4]['top']??'50'}}%; left:{{$textData[4]['left']??'50'}}%; font-size:7.5pt; max-width:38%; text-align:left; line-height:2; letter-spacing:2.2;">{{$textData[4]['text'] ?? ''}}</div>
    ...
    <div id="frontimg4" class="img-radius" style="position:absolute; width:48%; height:31.63%; top:{{$imageData[2]['top']??'50'}}%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[2]['image'] }}')"></div>
    ...
    <div id="textArea5" style="position:absolute; width:{{$textData[7]['width']??'50'}}%; height:{{$textData[7]['height']??'50'}}%; top:{{$textData[7]['top']??'50'}}%; left:{{$textData[7]['left']??'50'}}%; font-size:7.5pt; max-width:38%; text-align:left; letter-spacing:1.5; line-height:2;">{{$textData[7]['text'] ?? ''}}</div>
    ...
    <div id="frontimg6" class="img-radius" style="position:absolute; width:50%; height:41.04%; top:{{$imageData[3]['top']??'50'}}%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[3]['image'] }}')"></div>
    ...
    <div id="textArea7" style="position:absolute;  width:51%; height:{{$textData[9]['height']??'50'}}%; top:{{$textData[9]['top']??'50'}}%; left:{{$textData[9]['left']??'50'}}%; font-size:7.5pt; max-width:38%; text-align:left;  letter-spacing:1.5; line-height:2;">{{$textData[9]['text'] ?? ''}}</div>
    ...
    <div id="frontimg8" class="img-radius" style="position:absolute; width:50%; height:37.61%;  top:{{$imageData[4]['top']??'50'}}%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[4]['image'] }}')"></div>
    ...
    <div id="frontimg10" class="img-radius" style="position:absolute; width:48%; height:45.31%; top:top:{{$imageData[5]['top']??'50'}}%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[5]['image'] }}')"></div>
    ...
    <div id="textArea11-2" style="position:absolute; width:{{$textData[13]['width']??'50'}}%; height:{{$textData[13]['height']??'50'}}%; top:{{$textData[13]['top']??'50'}}%; left:{{$textData[13]['left']??'50'}}%; min-height:50%; max-height:30%; margin-bottom:2.5%; margin-top:2.5%; font-size:8.3pt; letter-spacing:1.2; line-height:2;">{{$textData[13]['text'] ?? ''}}</div>
    ...
    <div id="textArea12-1" style="position:absolute; width:{{$textData[14]['width']??'50'}}%; height:{{$textData[14]['height']??'50'}}%; top:{{$textData[14]['top']??'50'}}%; left:{{$textData[14]['left']??'50'}}%; transform: rotate(-8deg); width:34%; text-align:center; font-size:18pt; font-weight:bold; line-height:1; color:#fef8f6;">{{$textData[14]['text'] ?? ''}}</div>
    <div id="frontimg12-1" class="img-radius" style="position:absolute; width:28.25%; height:17.83%; top:14.37%;　left:18.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[6]['image'] }}')"></div>
    <div id="textArea12-2" style="position:absolute; width:{{$textData[15]['width']??'50'}}%; height:{{$textData[15]['height']??'50'}}%; top:{{$textData[15]['top']??'50'}}%; left:{{$textData[15]['left']??'50'}}%; font-size:7.5pt;">{{$textData[15]['text'] ?? ''}}</div>
    <div id="frontimg12-2" class="img-radius" style="position:absolute; width:28.25%; height:17.83%; top:35.6%; left: 18.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[7]['image'] }}')"></div>
    <div id="frontimg12-3" class="img-radius" style="position:absolute; width:70%; height:29.8%; top:56.56%; left:18.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[8]['image'] }}')"></div>
    <div id="textArea12-3" style="width:{{$textData[16]['width']??'50'}}%; height:{{$textData[16]['height']??'50'}}%; top:{{$textData[16]['top']??'50'}}%; left:{{$textData[16]['left']??'50'}}%; text-align:center; line-height:1.5; font-weight:bold; color:#fef8f6; font-size:12.3pt;">{{$textData[16]['text'] ?? ''}}</div>
