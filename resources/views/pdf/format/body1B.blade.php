...
<body style="background-color:{{$colors['backgroundColor'] ?? '#000000' }}; text-align:center; font-family:notosansjp,sans-serif;">
    ...
    <div id="frontimg1" class="img-radius" style="position:absolute; width: 45%; height:21%; top:40%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[0]['image'] }}')"></div>
    ...
    <div id="frontimg2" class="img-radius" style="position:absolute; width:45%; height:21%; top:41%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[1]['image'] }}')"></div>
    ...
    <div id="frontimg4" class="img-radius" style="position:absolute; width:45%; height:21%; top:36%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[2]['image'] }}')"></div>
    ...
    <div id="frontimg6" class="img-radius" style="position:absolute; width:45%; height:21%; top:41%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[3]['image'] }}')"></div>
    ...
    <div id="frontimg8" class="img-radius" style="position:absolute; width:45%; height:21%; top:44.5%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[4]['image'] }}')"></div>
    ...
    <div id="frontimg10" class="img-radius" style="position:absolute; width:45%; height:21%; top:41%; left:27.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[5]['image'] }}')"></div>
    ...
    <div id="frontimg12-1" class="img-radius" style="position:absolute; width:28%; height:16%; top:21%; left:18.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[6]['image'] }}')"></div>
    ...
    <div id="frontimg12-2" class="img-radius" style="position:absolute; width:28%; height:16%; top:39%; left: 18.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[7]['image'] }}')"></div>
    <div id="frontimg12-3" class="img-radius" style="position:absolute;width:63%; height:29%; top:58%; left:18.5%; background-size: contain; background-repeat: no-repeat; background-position: center; background-image: url('{{$imageData[8]['image'] }}')"></div>
